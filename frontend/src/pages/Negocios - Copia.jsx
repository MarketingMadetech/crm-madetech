...
function Negocios() {
  ...
  const ordenarNegocios = (negocios) => {
    return [...negocios].sort((a, b) => {
      ...
      if (ordenacao.campo === 'data_criacao' || ordenacao.campo === 'data_fechamento') {
        ...
        valorA = new Date(anoA, mesA - 1, diaA)
        valorB = new Date(anoB, mesB - 1, diaB)
      }
  ...
  const abrirWhatsApp = (negocio) => {
    // Extrair número de telefone da observação ou usar campo específico
